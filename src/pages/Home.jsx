...
import { FaArrowRight } from "react-icons/fa"                // Icon used for buttons and links
  ...
  return (
    <div>
      ...
      <div className="w-11/12 mx-auto max-w-maxContent flex-col items-center 
        ...
        {/* ---- Learner Reviews Placeholder ---- */}
        <h2 className='text-center text-4xl font-semibold mt-10'>
          Reviews from other Learners
        </h2>
        {/* TODO: Add ReviewSlider component here */}
      </div>
